...
type GithubBranchUpdateAPI = "v1" :> "github" :> "branches"
                          :> Capture "owner" Text
                          :> Capture "repository" Text
                          :> Capture "branchName" Text
                          :> QueryParam "project_id" Text
                          :> QueryParam "commit_sha" Text
                          :> ReqBody '[JSON] PersistentModel
                          :> Put '[JSON] GetBranchUpdateResponse
