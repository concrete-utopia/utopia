Greetings, Utopian. You're here for these, probably:


## Commands

heroku local                            spins up a local heroku server to test things
git push                                pushes to Bitbucket, our host
git push heroku master                  pushes AND DEPLOYS master to Heroku
                                        (our website at utopia2d.com)
https://www.favicon-generator.org/      to generate favicons (important :)
git add folder/                         to add folders (git status doesn't see them otherwise)


## Where to put things

/src/App.js                             the actual site
/public                                 all public stuff


## How to reference things

./logoUtopia.svg                        is /public/logoUtopia.svg


## Key Dependencies

styled-components                        for inline styles
http://jxnblk.com/rebass/                for better inline styles
https://github.com/jxnblk/grid-styled    for easier grids 
