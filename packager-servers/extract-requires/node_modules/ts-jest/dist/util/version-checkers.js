...
exports.VersionCheckers = {
    jest: createVersionChecker('jest', ">=26 <27" /* Jest */),
    typescript: createVersionChecker('typescript', ">=3.8 <5" /* TypeScript */),
    babelJest: createVersionChecker('babel-jest', ">=26 <27" /* BabelJest */),
    babelCore: createVersionChecker('@babel/core', ">=7.0.0-beta.0 <8" /* BabelCore */),
};
