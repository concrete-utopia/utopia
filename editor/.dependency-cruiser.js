module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        pathNot:
          '\\.(benchmark|spec|test|spec.browser|spec.browser2|test-utils)\\.(js|mjs|cjs|ts|tsx|ls|coffee|litcoffee|coffee\\.md)$|(src/scripts/.*$)',
      },
      to: {
    ...
    },
    {
      ...
      to: {
        path: '^src/core/workers/ts',
        pathNot: ['^src/core/workers/ts/ts-utils'],
      },
    },
    {
      name: 'not-from-editor-to-typescript',
      comment: '',
      severity: 'error',
      from: {
        path: 'editor.tsx',
...
// generated: dependency-cruiser@9.17.1 on 2020-11-26T12:15:01.668Z
