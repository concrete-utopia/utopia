...
export const SampleFileBuildResult = JSON.parse(`{
  ...
  "/src/index.js": {
    "errors": [],
    "transpiledCode": "System.register([\\"react\\", \\"react-dom\\", \\"../src/app\\"], function (exports_1, context_1) {\\n  \\"use strict\\";\\n\\n  var React, ReactDOM, app_1, root;\\n\\n  var __moduleName = context_1 && context_1.id;\\n\\n  return {\\n    setters: [function (React_1) {\\n      React = React_1;\\n    }, function (ReactDOM_1) {\\n      ReactDOM = ReactDOM_1;\\n    }, function (app_1_1) {\\n      app_1 = app_1_1;\\n    }],\\n    execute: function execute() {\\n      root = document.getElementById(\\"root\\");\\n\\n      if (root != null) {\\n        ReactDOM.render(React.createElement(app_1.App, null), root);\\n      }\\n    }\\n  };\\n}); //# sourceMappingURL=index.js.map",
    "sourceMap": {
      "version": 3,
      "sources": [
        "../src/index.js"
      ...
      "names": [],
      "mappings": ";;;;;;;;;;;;;;;;AAIM,MAAA,IAAI,GAAG,QAAQ,CAAC,cAAT,CAAwB,MAAxB,CAAP;;AACN,UAAI,IAAI,IAAI,IAAZ,EAAkB;AAChB,QAAA,QAAQ,CAAC,MAAT,CAAgB,KAAA,CAAA,aAAA,CAAC,KAAA,CAAA,GAAD,EAAI,IAAJ,CAAhB,EAAyB,IAAzB;AACD;AAAC",
      "sourcesContent": [
