...
const light = {
  ...
  inspectorDisabledSegmentSelectorColor: lightControls.inputBorder,
  ...
  inspectorControlledMainColor: createUtopiColor('#0091FF', '', ''),
  ...
  inspectorControlledSegmentTrackColor: createUtopiColor('#0091FF', '', '').o(5),
