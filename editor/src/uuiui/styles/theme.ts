...
const base = {
  ...
  violet: createUtopiColor('violet', ' Violet', 'violet'),
...
const light = {
  ...
  inspectorControlledMainColor: createUtopiColor('rgba(119, 119, 255, 1)', '', ''),
  inspectorControlledBorderColor: createUtopiColor('rgba(14, 141, 222, .5)', '', ''),
  inspectorControlledBackgroundColor: createUtopiColor('rgba(119, 119, 255, 0.05)', '', ''),
  inspectorControlledBackgroundOnColor: createUtopiColor('rgba(119, 119, 255, 0.25)', '', ''),
  inspectorControlledBackgroundOffColor: createUtopiColor('rgba(119, 119, 255, 0.05)', '', ''),
...
const dark = {
  ...
  resizingDisplayForeground: createUtopiColor('hsl(0,0%,90%)', '90%', 'light'),
  navigatorResizeHintBorder: lightBase.primary,
  navigatorName: lightBase.primary,
  ...
  inspectorControlledBackgroundColor: darkBase.primary.o(5),
  inspectorControlledBackgroundOnColor: darkBase.primary.o(25),
  inspectorControlledBackgroundOffColor: darkBase.primary.o(5),
