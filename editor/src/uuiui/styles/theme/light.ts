...
const lightBase = {
  ...
  componentPurple10: createUtopiColor('oklch(53.19% 0.307 289.7 / 10%)'),
  ...
  aqua40: createUtopiColor('oklch(0.92 0.07 211.23 / 0.41)'),
  bg510: createUtopiColor('oklch(60% 0 0 / 10%)'),
...
const lightTheme = {
  ...
  canvasLiveBackground: lightBase.fg8,
