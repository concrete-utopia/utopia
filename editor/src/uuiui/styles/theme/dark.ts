...
const darkBase = {
  ...
  componentPurple10: createUtopiColor('oklch(76% 0.155 300 / 10%)'),
  ...
  aqua40: createUtopiColor('oklch(86% 0.135 208.71 / 10%)'),
  aqua05solid: createUtopiColor('oklch(0.41 0.03 238.48)'),
  bg510: createUtopiColor('oklch(63.09% 0.023 271.03 / 10%)'),
...
const darkTheme: typeof light = {
  ...
  canvasLiveBackground: darkBase.bg4,
