...
export const flowInlineReorderStategy: CanvasStrategy = {
  id: 'FLOW_INLINE_REORDER',
  name: 'Reorder(Inline)',
  ...
  fitness: (canvasState, interactionState, strategyState) => {
    return flowInlineReorderStategy.isApplicable(
      canvasState,
      interactionState,
      ...
      if (realNewIndex === unpatchedIndex) {
        return {
          commands: [
            ...
            convertInlineBlock('always', target, 'inline-block'),
          ],
          customState: {
