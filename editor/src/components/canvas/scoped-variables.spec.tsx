  ...
  it('includes scoped variables for an inline component destructuring the parameter', async () => {
    ...
    expect(renderResult.getEditorState().editor.variablesInScope).toMatchInlineSnapshot(`
      Object {
        ...
        "storyboard-entity/scene-1-entity/app-entity:cb0/fakeawaitelement/498/something-div~~~1": Object {
          "first": Object {
            "insertionCeiling": Object {
              "parts": Array [
                Array [
  ...
  it('includes scoped variables for an inline component', async () => {
    ...
    expect(renderResult.getEditorState().editor.variablesInScope).toMatchInlineSnapshot(`
      Object {
        ...
        "storyboard-entity/scene-1-entity/app-entity:cb0/fakeawaitelement/798/something-div~~~1": Object {
          "props": Object {
            "insertionCeiling": Object {
              "parts": Array [
                Array [
