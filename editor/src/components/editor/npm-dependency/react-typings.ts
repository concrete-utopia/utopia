/* eslint-disable */
// The .d.ts files for React and ReactDOM, since these are peer dependencies to our npm-dependency loader
// so we must manually ensure Monaco understands these types
// I am open to any ideas better than this

// react.d.ts from https://unpkg.com/@types/react@16.8.14/index.d.ts
export const reactTypings = `// Type definitions for React 16.8
...
// react-dom.d.ts from https://unpkg.com/@types/react-dom@16.8.4/index.d.ts
export const reactDomTypings = `// Type definitions for React (react-dom) 16.8
// Project: http://facebook.github.io/react/
// Definitions by: Asana <https://asana.com>
//                 AssureSign <http://www.assuresign.com>
//                 Microsoft <https://microsoft.com>
...
export const reactGlobalTypings = `/*
