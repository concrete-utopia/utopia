...
const PullIcon = ({ fill }: { fill?: string }) => {
  return (
    <svg width='16' height='13' viewBox='0 0 16 13' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        fill={fill ?? colorTheme.fg9.value}
      />
      <path
...
const PushIcon = ({ fill }: { fill?: string }) => {
  return (
...
const BranchNotLoadedBlock = () => {
  ...
  return (
    <Block title='Contents' status='pending' expanded={true} last={true}>
      <FlexColumn style={{ gap: 4, width: '100%' }}>
        {flow == null ? (
          <>
            <Button
              spotlight
            ...
            >
              <PullIcon fill={colorTheme.fg0.value} />
              Load from branch
            </Button>
            ...
            <FlexColumn style={{ gap: 2 }}>
              ...
              >
                <PushIcon fill={colorTheme.fg0.value} />
          ...
          <>
            {when(
              ...
              <UIGridRow padded={false} variant='<-------------1fr------------->'>
                ...
                >
                  {isGithubLoadingAnyBranch(githubOperations) ? (
                    <GithubSpinner />
                  ) : (
                    <>
                      <PullIcon fill={colorTheme.errorForeground.value} />
