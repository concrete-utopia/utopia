...
describe('React Render Count Tests - ', () => {
  it('Clicking on opacity slider', async () => {
    ...
    expect(renderCountAfter - renderCountBefore).toBeGreaterThan(490) // if this breaks, GREAT NEWS but update the test please :)
  ...
  it('Changing the selected view', async () => {
    ...
    const renderCountAfter = renderResult.getNumberOfRenders()
    expect(renderCountAfter - renderCountBefore).toBeGreaterThanOrEqual(475) // if this breaks, GREAT NEWS but update the test please :)
