...
describe('React Render Count Tests - ', () => {
  it('Clicking on opacity slider', async () => {
    ...
    expect(renderCountAfter - renderCountBefore).toBeGreaterThan(715) // if this breaks, GREAT NEWS but update the test please :)
    expect(renderCountAfter - renderCountBefore).toBeLessThan(725)
  })
