...
describe('React Render Count Tests - ', () => {
  it('Clicking on opacity slider', async () => {
    ...
    expect(renderCountAfter - renderCountBefore).toBeGreaterThan(480) // if this breaks, GREAT NEWS but update the test please :)
  ...
  it('Changing the selected view', async () => {
    ...
    const renderCountAfter = renderResult.getNumberOfRenders()
    expect(renderCountAfter - renderCountBefore).toBeGreaterThanOrEqual(455) // if this breaks, GREAT NEWS but update the test please :)
    expect(renderCountAfter - renderCountBefore).toBeLessThan(465)
  })
})
