...
export const ScenePathForTestUiJsFile = testStaticScenePath([ElementPathForTestUiJsFile])
export const InstancePathForTestUiJsFile = testStaticInstancePath(
  emptyScenePath,
  ElementPathForTestUiJsFile,
)
