...
export function clearCachedUidsPerFileSixth() {
  CachedUidsPerFile = new WeakMap()
}

export function lookupFilePathForUidSixth(mapping: FileToUidMapping, uid: string): string | null {
...
export function getAllUniqueUidsInnerSixth(
  projectContents: ProjectContentTreeRoot,
): FileToUidMapping {
  return collectUidsForEachFile(projectContents).filePathToUids
}

export const getAllUniqueUidsSixth = memoize(getAllUniqueUidsInnerSixth)
