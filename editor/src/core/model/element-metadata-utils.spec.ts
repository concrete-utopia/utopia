...
describe('getElementLabel', () => {
  ...
  const spanElement = jsxElement('span', { 'data-uid': jsxAttributeValue('span-1', emptyComments) }, [textBlock])
  ...
  const divElement = jsxElement('div', { 'data-uid': jsxAttributeValue('div-1', emptyComments) }, [spanElement])
