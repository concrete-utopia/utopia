...
function generateConsistentUID(existingIDs: Set<string>, possibleStartingValue: string): string {
...
function generateUID(existingIDs: Array<string> | Set<string>): string {
