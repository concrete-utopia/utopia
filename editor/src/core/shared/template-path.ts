...
export const emptyScenePath: StaticScenePath = newScenePath([]) as StaticScenePath
...
export function staticScenePath(elementPaths: ElementPath[]): StaticScenePath {
