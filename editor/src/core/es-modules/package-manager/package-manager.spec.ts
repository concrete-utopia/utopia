...
import * as reactSpringTypingsServerResponse from '../test-cases/react-spring-typings-server-response.json'
...
import * as antdTypingsResponse from '../test-cases/andtd-typings-response.json'
