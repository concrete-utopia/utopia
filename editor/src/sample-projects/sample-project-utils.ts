  ...
  return {
    src: {
      ...
      children: {
        ...
        'multipleproviderscard.js': {
          type: 'PROJECT_CONTENT_FILE',
          fullPath: '/src/multipleproviderscard.js',
          content: {
            type: 'TEXT_FILE',
            lastRevisedTime: 0,
            lastParseSuccess: null,
        ...
        'threecolumngridview.js': {
          type: 'PROJECT_CONTENT_FILE',
          fullPath: '/src/threecolumngridview.js',
          content: {
            type: 'TEXT_FILE',
            lastRevisedTime: 0,
            lastParseSuccess: null,
        ...
        'card.js': {
          ...
          content: {
            ...
            lastSavedContents: null,
            fileContents: {
              code: "export var Card = (props) => {\n  return (\n    <>\n      <img\n        src='https://source.unsplash.com/jPmurJKSL_0/600x800'\n        style={{ width: '100%' }}\n        alt='beach'\n      />\n      <div\n        style={{\n          color: '#685B38',\n          backgroundColor: 'white',\n          padding: 20,\n          fontFamily: 'ITC Garamond',\n          fontSize: '14pt',\n        }}\n      >\n        {props.title}, {props.label} <br></br> {props.copy}\n      </div>\n    </>\n  )\n}\n",
              parsed: {
                type: 'UNPARSED',
              },
              revisionsState: 'CODE_AHEAD',
