...
export const PreviewReactSelectDeviceSelector: React.FunctionComponent<React.PropsWithChildren<PreviewReactSelectDeviceSelectorProps>> = ({ value, onChange, caratOffset }) => {
